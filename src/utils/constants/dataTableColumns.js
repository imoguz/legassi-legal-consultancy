...
export const matterColumns = [
  ...
  },
  {
    ...
    width: 150,
    render: (client) => (
      <div className="truncate" title={client?.fullName || "-"}>
        {client?.fullName || "-"}
      </div>
    ),
  },
  ...
  },
  {
    ...
    filters: [],
    render: (stage) => (
      <Tag color={stageColorMap[stage]} className="capitalize">
        {stage}
      </Tag>
    ),
  },
  {
    ...
    filters: [],
    render: (priority) => (
      <Tag color={priorityColorMap[priority]} className="capitalize">
        {priority}
      </Tag>
    ),
  },
  {
    ...
    key: "primaryAttorney",
    width: 150,
    render: (attorney, record) => {
      const fullName = attorney
      ...
      return (
        <div className="truncate">
          ...
          {/* Team count */}
          <Tag color="blue" className="mt-1 inline-block">
            {teamCount} member(s)
          </Tag>
        </div>
      );
  ...
  },
  {
    ...
    filters: [],
    render: (dates) => {
      if (!dates?.openingDate) return "-";
      const date = new Date(dates.openingDate);
      return (
